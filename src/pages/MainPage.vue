                ...
                <el-submenu index="1-1">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="1-1"
                                  @click="goto('courseBasicInformation')">课程基本信息
                    </el-menu-item>
                    <el-menu-item index="1-2" @click="goto('programObjective')">课程目标设置</el-menu-item>
                    <!-- <el-menu-item index="1-3" @click="goto('indexPoint')">课程毕业要求指标点</el-menu-item> -->
                    <el-menu-item index="1-4"
                                  @click="goto('basicInformationTable')">课程考核评价方式
                    </el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
                ...
                <el-submenu index="2">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="2-1"
                                  @click="goto('finalPaperSetting')">考试命题与指标点关系
                    </el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
              </el-menu-item-group>
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                ...
                <el-submenu index="2">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="2-1"
                                  @click="goto('usualPreformanceTable')">平时考核成绩统计
                    </el-menu-item>
                    <el-menu-item index="2-2"
                                  @click="goto('finalStatisticsTable')">期末试卷成绩统计
                    </el-menu-item>
                  </el-menu-item-group>
                </el-submenu>
                <el-submenu index="3">
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <el-submenu index="1-1">
                  ...
                  <el-menu-item-group>
                    <el-menu-item index="1-1"
                                  @click="goto('finalComprehensiveTable')">期末综合成绩统计表
                    </el-menu-item>
                    <el-menu-item index="1-2" @click="goto('editAnalyseReport')">编辑试卷分析报告</el-menu-item>
                    <el-menu-item index="1-3"
                                  @click="goto('editTeachingSummary')">编辑教学小结表
                    </el-menu-item>
                  ...
                  <el-menu-item-group>
                      ...
                      <el-submenu index="1-3">
                          ...
                          <el-menu-item-group>
                            ...
                            <el-menu-item index="1-7" @click="goto('educationProgramManagement')">专业培养方案管理</el-menu-item>
                            <el-menu-item index="1-7" @click="goto('indicatorsSettings')">专业指标点管理</el-menu-item>
                          </el-menu-item-group>
                        </el-submenu>
                      </el-submenu>
                  </el-menu-item-group>
